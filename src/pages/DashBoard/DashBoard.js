    ...
    return (
        <div className="drawer drawer-mobile">
            ...
            <div className="drawer-content ">
                <h2 className='text-2xl text-primary font-semibold'>Welcome to Your dashboard {user.role}</h2>
                <Outlet></Outlet>
            </div>
                ...
                <ul className="menu p-4 overflow-y-auto w-68 bg-base-100 text-base-content">
                    ...
                    <li className='text-primary'><Link to="/dashboard/myProfile">My Profile</Link></li>
                    {
                        admin && <>
                            ...
                            <li className='text-primary'><Link to="/dashboard/users">Manage All orders</Link></li>
                            <li className='text-primary'><Link to="/dashboard/users">Add products</Link></li>
                            <li className='text-primary'><Link to="/dashboard/users">Manage Product</Link></li>
                        </>
                    }
